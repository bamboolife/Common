...
import static com.bamboo.common.utils.DensityUtils.dp2px;
...
public class HwLoadingView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mSize = (int) ta.getDimension(R.styleable.HwLoadingView_v_size, dp2px(context, 100));
        setSize(mSize);
        mColor = ta.getColor(R.styleable.HwLoadingView_v_color, Color.parseColor("#333333"));
        setColor(mColor);
        mDuration = ta.getInt(R.styleable.HwLoadingView_a_duration, 1500);
        ta.recycle();
    }
