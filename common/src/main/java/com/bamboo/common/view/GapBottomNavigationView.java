...
public class GapBottomNavigationView extends FrameLayout {
    ...
    public GapBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.setItemIconSize(a.getDimensionPixelSize(R.styleable.BottomNavigationView_itemIconSize, this.getResources().getDimensionPixelSize(R.dimen.design_bottom_navigation_icon_size)));
...
//屏蔽中间按钮的点击事件
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        LayoutParams dividerParams = new LayoutParams(-1, this.getResources().getDimensionPixelSize(R.dimen.design_bottom_navigation_shadow_height));
