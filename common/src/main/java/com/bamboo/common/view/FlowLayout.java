...
import com.bamboo.common.gilde.CropCircleTransformation;
...
//            Collections.reverse(lineViews);
    ...
    private void setViews() {
        ...
        for (int i = 0; i < allUrls.size(); i++) {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(context).inflate(R.layout.bbl_praise_layout, this, false);

            Glide.with(context)
                    .load(allUrls.get(i))
                    .placeholder(R.mipmap.ic_pets_white_48dp)
