...
/**
 * Author:Ken
 * Data：2018/12/5-10:18
 * Todo: 刷新方法 可以嵌套lsitView 和GridView，实时更新下拉的高度
 * Todo: 仿微信下拉头部小程序列表
 */

public class PullToRefrshLinearLayout extends LinearLayout {
    // private static final String TAG = "PullToRefrshLinearLayout";
    // refresh states
    ...
    private void addHeaderView() {
        ...
        mWeixcView = (LinearLayout) mHeaderView.findViewById(R.id.lin_wxxc);
